...
-- Static Content
local CONTENT = {
					rules = {"=== Server Rules ===", " ", "Do not research Landfill before we go to the Silo", " ", " ", "Admins :", " ", "chpich", "naquada", "twinotter", "redlabel", "red11", "adlmr", "d4vyjones", "order", "kevin_ar18", "ciber_man", "total", "altech", "fred1992", "dq_shell", "i1728"}, 
					...
					about = {"=== ABOUT ===", "Welcome to the official Crash Site server (v2.4.3) ", " ", "Any problem/suggestion? or just want to discuss about the map? Join the Steam Group :", "http://steamcommunity.com/groups/factorio-crashsite", " ", "This server is hosted by www.multiplaygameservers.com and owned by chpich.", " ", "=== SOFTMODS INSTALLED: === ", "Gravestone, Tags, Player List, ShowHealth", " ", "* CREDITS FOR CODING SOFTMODS: 3RA"}
				}
